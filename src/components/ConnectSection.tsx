      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div ref={contactMethodsRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {connectData.contactMethods.map((method, index) => (
            ...
            >
              <div className="bg-gray-900/70 border border-gray-700 rounded-2xl p-8 h-48 flex flex-col items-center justify-center text-center hover:border-purple-400/50 hover:shadow-lg hover:shadow-purple-400/20 transition-[border-color,box-shadow] duration-300 group">
        ...
        <div ref={ctaButtonRef} className="mb-16">
          <a
            ...
            className="inline-block bg-linear-to-r from-purple-500 via-pink-500 to-cyan-500 text-white font-bold text-lg px-12 py-4 rounded-2xl hover:shadow-lg hover:shadow-purple-400/30 transition-[box-shadow] duration-300 group relative overflow-hidden"
          >
          ...
          {[
            ...
            { name: 'Instagram', url: personalInfo.social.instagram }
              ...
              <a
                ...
                className="social-icon w-12 h-12 bg-gray-800/80 border border-gray-700 rounded-xl flex items-center justify-center hover:border-purple-400/50 hover:bg-purple-500/10 transition-[border-color,background-color] duration-300 group"
