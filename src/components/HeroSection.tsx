...
export default function HeroSection() {
  ...
  const getInTouchRef = useMagnetic<HTMLButtonElement>();
          ...
          <div className="lg:col-span-2 text-center order-2 lg:order-2">
            ...
            <div ref={techStackRef} className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-6 lg:mb-8 px-4 sm:px-0">
              {techStack.featured.map((tech) => (
                <span
                  key={tech}
                  className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gray-900 border border-gray-700 rounded-full text-xs sm:text-sm font-medium hover:bg-gray-800 hover:border-purple-400/50 transition-all duration-300"
                >
                  {tech}
                </span>
              ))}
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              <button
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-purple-400/30 hover:scale-105 transition-all duration-300 text-sm sm:text-base"
              >
                View My Work
              </button>
              <button
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 border border-gray-700 text-gray-300 font-semibold rounded-full hover:border-purple-400/50 hover:text-white hover:scale-105 transition-all duration-300 text-sm sm:text-base"
              >
                Get In Touch
              </button>
            </div>
